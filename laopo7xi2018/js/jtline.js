        ...
        jTLine: function (options) {
            ...
            var updateVisibleContent = function (event, eventsContent) {
                ...
                for (var i = 0; i < fetchedData.length; ++i) {
                    if (fetchedData[i].assignDate == eventDate) {
                        newWordCloud = wordCloud(".word-cloud");
                        showNewWords(newWordCloud, extractWords(fetchedData[i].taskDetails));
                        break;
                    }
                }
            ...
            var extractWords = function(content) {
            ...
            var showNewWords = function (vis, words) {
                vis.update(words.map(function (d) {
                    return { text: d, size: 16 + Math.random() * 16 };
                }))
            }
            ...
            */
            ...
            var formatTitle = function (title, obj) {
                ...
                if (formatTitleResult)
                    ...
                    return '<h2 style="font-size: 20px;">' + title + '</h2>';
            }
            ...
            var formatSubTitle = function (subTitle, obj) {
                ...
                if (formatSubTitle)
                    ...
                    return '<em style="font-size: 16px;">' + point.subTitle + '</em>';
            }
            ...
            var formatBodyContent = function (bodyCnt, obj) {
                ...
                if (formatBodyCnt)
                    ...
                    return '<p style="font-size: 10px;">' + bodyCnt + '</p>';
            }
